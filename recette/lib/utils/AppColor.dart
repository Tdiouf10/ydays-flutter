...
class AppColor {
  static Color primary = Color(0xFF042B11);
  static Color primarySoft = Color(0xFF2F7D2D);
  ...
  static LinearGradient bottomShadow = LinearGradient(colors: [Color(0xFF107873).withOpacity(0.2), Color(
